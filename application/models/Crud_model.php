...
class Crud_model extends CI_Model
{
    ...
    function update_light_logo($name)
    {



        $data['description'] =  $name;
        $this->db->where('type', 'system logo');
    ...
    function update_frontend_banner($name)
    {



        $data['description'] =  $name;
        $this->db->where('type', 'banner image');
        $this->db->update('settings', $data);
        return true;
    }
