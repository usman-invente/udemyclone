											...
											<div class="form-group">
												<label class="col-md-12" for="example-text"><?php echo translate('name');?> <b style="color:red">*</b></label>
													<div class="col-sm-12">
															...
															placeholder="<?php echo $user_details['first_name'].' '.$user_details['last_name']; ?>" 
															value="<?php echo $user_details['first_name'].' '.$user_details['last_name']; ?>"  required>
													</div>
											</div>
											...
											<div class="form-group">
												<label class="col-md-12" for="example-text"><?php echo translate('email');?> <b style="color:red">*</b></label>
													<div class="col-sm-12">
														 ...
														 placeholder="<?php echo $user_details['email']; ?>" value="<?php echo $user_details['email']; ?>" required>
													</div>
											</div>
