...
<link rel="icon"  sizes="16x16" href="<?php echo base_url() ?>uploads/system/<?= get_settings('favicon') ?>">
  ...
  <div class="login-box login-sidebar">
    ...
    <div class="white-box">
	    ...
	    <br><br><br>
            ...
            <img src="<?php echo base_url() . 'uploads/system/' . get_settings('system logo'); ?>" class="img-circle" width="70" height="70"/></h4>
