								...
								<div class="row">
									...
									<div class="col-sm-6">
										<form action="<?= base_url() ?>admin/settings/general" method="post" class="form-horizontal form-groups-bordered">
											...
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="text" class="form-control bootstrap-tag-input" id="website_keywords" name="website_keywords" data-role="tagsinput" style="width: 100%;" value="<?= get_settings('website_keywords') ?>" />
												</div>
											</div>
									...
									<div class="col-sm-6">
										...
										<div class="form-group">
											...
											<div class="col-sm-12">
												<input type="text" name="website_description" id="website_description" class="form-control" value="<?= get_settings('website_description') ?>" required>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-12">
												<input type="password" name="youtube_api_key" id="youtube_api_key" class="form-control" value="<?= get_settings('youtube_api_key') ?>" required>
										...
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="panel panel-info">
												...
												<div class="row panel-body">
													...
													<div class="col-sm-10">
														<input type="text" name="phrase<?= $phrase_id; ?>" id="phrase-<?= $phrase_id; ?>" value="<?= $phrase_language; ?>" onkeyup="enableUpdateButton(<?= $phrase_id; ?>)" class="form-control" />
													</div>

													<div class="col-sm-2">
														<button type="button" name="button" class="btn btn-xs btn-success pull-right" id="button-<?= $phrase_id; ?>" disabled onclick="updatePhrase(<?= $phrase_id; ?>)">
										...
										<table id="example23" class="display nowrap" cellspacing="0" width="100%">
											<thead>
												<tr>
													...
													<th>
														<div align="right"><?php echo translate('actions'); ?></div>
													</th>
												</tr>
											</thead>
											<tbody>
															...
															<div align="right">
																...
																<a href="#" onclick="confirm_modal('<?php echo base_url(); ?>admin/language/delete_language/<?= $field; ?>')">
																	<button type="button" class="btn btn-danger btn-rounded btn-sm"><i class="fa fa-times" onclick="return confirm('Delete Language ?');"></i>
																		<?php echo translate('delete'); ?></button></a>
															</div>
									</div>
									</td>
									</tr>
								...
								<div class="form-group">
									...
									<div class="col-sm-12">
										<select class="form-control select2" data-toggle="select2" id="paypal_currency" name="paypal_currency" required>
											...
											foreach ($currencies as $currency) {
											?>
												<option value="<?php echo $currency['code']; ?>" <?php if (get_settings('paypal_currency') == $currency['code']) echo 'selected'; ?>><?php echo $currency['code']; ?></option>
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							<select class="form-control select2" data-toggle="select2" id="stripe_currency" name="stripe_currency" required>
								...
								foreach ($currencies as $currency) {
								?>
									<option value="<?php echo $currency['code']; ?>" <?php if (get_settings('stripe_currency') == $currency['code']) echo 'selected'; ?>><?php echo $currency['code']; ?></option>
				...
				<div class="col-sm-6">
					<form class="" action="<?php echo site_url('admin/settings/system_image'); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-12">
								<input type="file" required class="form-control" name="light_logo" value="">
								<img src="<?php echo base_url() ?>uploads/system/<?= get_settings('system logo') ?>" height="50" width="150">
							</div>
						</div>
				...
				<div class="col-sm-6">
					<form class="" action="<?php echo site_url('admin/settings/favicon'); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-12">
								<input  required type="file" class="form-control" name="favicon" value="">
								<img src="<?php echo base_url() ?>uploads/system/<?= get_settings('favicon') ?>" height="50" width="150">
							</div>
						</div>
				...
				<div class="col-sm-6">
					<form class="" action="<?php echo site_url('admin/settings/banner_image'); ?>" method="post" enctype="multipart/form-data">
						<div class="form-group">
							...
							<div class="col-sm-12">
								<input type="file" class="form-control" required  name="banner_image" value="">
								<img src="<?php echo base_url() ?>uploads/system/<?= get_settings('banner image') ?>" height="50" width="150">
							</div>
						</div>
