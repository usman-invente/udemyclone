    ...
    <div class="row align-items-end">
      ...
      <div class="col-lg-8">
        ...
        <div class="course-header-wrap">
          ...
          <span class="d-inline-block average-rating"><?php echo $average_ceil_rating; ?></span><span>(<?php echo $number_of_ratings.' '.translate('ratings'); ?>)</span>
          ...
          <span class="enrolled-num">
            ...
            echo $number_of_enrolments.' '.translate('students_enrolled');
        ...
        <div class="created-row">
          ...
          <?php if ($course_details['last_modified'] > 0): ?>
            ...
            <span class="last-updated-date"><?php echo translate('last_updated').' '.date('D, d-M-Y', $course_details['last_modified']); ?></span>

          <?php else: ?>

            <span class="last-updated-date"><?php echo translate('last_updated').' '.date('D, d-M-Y', $course_details['date_added']); ?></span>
...
<section class="course-content-area">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <div class="what-you-get-box">
          ...
          <div class="what-you-get-title"><?php echo translate('what_will_i_learn'); ?>?</div>
        ...
        <div class="course-curriculum-box">
          ...
          <div class="course-curriculum-title clearfix">
            ...
            <div class="title float-left"><?php echo translate('curriculum_for_this_course'); ?></div>

            <div class="float-right">

              <span class="total-lectures">

                <?php echo $this->crud_model->get_lessons('course', $course_details['id'])->num_rows().' '.translate('lessons'); ?>
              ...
              <div class="lecture-group-title clearfix" data-toggle="collapse" data-target="#collapse<?php echo $section['id']; ?>" aria-expanded="<?php if($counter == 0) echo 'true'; else echo 'false' ; ?>">
                ...
                <div class="float-right">
                  ...
                  <span class="total-lectures">
                    ...
                    <?php echo $this->crud_model->get_lessons('section', $section['id'])->num_rows().' '.translate('lessons'); ?>
    ...
    <div class="requirements-box">
      ...
      <div class="requirements-title"><?php echo translate('requirements'); ?></div>
    ...
    <div class="description-box view-more-parent">
      ...
      <div class="view-more" onclick="viewMore(this,'hide')">+ <?php echo translate('view_more'); ?></div>

      <div class="description-title"><?php echo translate('description'); ?></div>
    ...
    <div class="compare-box view-more-parent">
      ...
      <div class="view-more" onclick="viewMore(this)">+ <?php echo translate('view_more'); ?></div>

      <div class="compare-title"><?php echo translate('other_related_courses'); ?></div>
            ...
            <div class="course-comparism-item clearfix">
              ...
              <div class="item-title float-left">
                ...
                <?php if ($other_realted_course['last_modified'] > 0): ?>
                  ...
                  <div class="updated-time"><?php echo translate('updated').' '.date('D, d-M-Y', $other_realted_course['last_modified']); ?></div>

                <?php else: ?>

                  <div class="updated-time"><?php echo translate('updated').' '.date('D, d-M-Y', $other_realted_course['date_added']); ?></div>
              ...
              <div class="item-details float-left">
                ...
                <?php if ($other_realted_course['is_free_course'] == 1): ?>
                  ...
                  <span class="item-price">
                    ...
                    <span class="current-price"><?php echo translate('free'); ?></span>
  ...
  <div class="about-instructor-box">
    ...
    <div class="about-instructor-title">
      ...
      <?php echo translate('about_the_instructor'); ?>
      ...
      <div class="col-lg-4">
        ...
        <div class="about-instructor-image">
          ...
          <ul>
            ...
            </b> <?php echo translate('reviews'); ?></li>
  ...
  <div class="student-feedback-box">
    ...
    <div class="student-feedback-title">
      ...
      <?php echo translate('student_feedback'); ?>
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="title"><?php echo translate('average_rating'); ?></div>
  ...
  <div class="reviews">
    ...
    <div class="reviews-title"><?php echo translate('reviews'); ?></div>
    ...
    <?php if ($course_details['video_url'] != ""): ?>
      ...
      <div class="preview-video-box">
        ...
        <a data-toggle="modal" data-target="#CoursePreviewModal">
          ...
          <span class="preview-text"><?php echo translate('preview_this_course'); ?></span>
    ...
    <div class="course-sidebar-text-box">
      ...
      <div class="price">
        ...
        <?php if ($course_details['is_free_course'] == 1): ?>
          ...
          <span class = "current-price"><span class="current-price"><?php echo translate('free'); ?></span></span>
      ...
      <?php if(is_purchased($course_details['id'])) :?>
        ...
        <div class="already_purchased">
          ...
          <a href="<?php echo site_url('home/my_courses'); ?>"><?php echo translate('already_purchased'); ?></a>
      ...
      <?php else: ?>
        ...
        <?php if ($course_details['is_free_course'] == 1): ?>
          ...
          <div class="buy-btns">
            ...
            <?php if ($this->session->userdata('user_login') != 1): ?>
              ...
              <a href = "#" class="btn btn-buy-now" onclick="handleEnrolledButton()"><?php echo translate('get_enrolled'); ?></a>

            <?php else: ?>

              <a href="<?php echo site_url('home/get_enrolled_to_free_course/'.rawurlencode(slugify($course_details['title'])).'/'.$course_details['id']); ?>" class="btn btn-buy-now"><?php echo translate('get_enrolled'); ?></a>
        ...
        <?php else: ?>
          ...
          <div class="buy-btns">
            ...
            <a href = "javascript::" class="btn btn-buy-now" id = "course_<?php echo $course_details['id']; ?>" onclick="handleBuyNow(this)"><?php echo translate('buy_now'); ?></a>

            <?php if (in_array($course_details['id'], $this->session->userdata('cart_items'))): ?>

              <button class="btn btn-add-cart addedToCart" type="button" id = "<?php echo $course_details['id']; ?>" onclick="handleCartItems(this)"><?php echo translate('added_to_cart'); ?></button>

            <?php else: ?>

              <button class="btn btn-add-cart" type="button" id = "<?php echo $course_details['id']; ?>" onclick="handleCartItems(this)"><?php echo translate('add_to_cart'); ?></button>
      ...
      <div class="includes">
        ...
        <div class="title"><b><?php echo translate('includes'); ?>:</b></div>
        ...
        <ul>
          ...
          <li><i class="far fa-file-video"></i>
            ...
            echo $this->crud_model->get_total_duration_of_lesson_by_course_id($course_details['id']).' '.translate('on_demand_videos');

            ?>

          </li>

          <li><i class="far fa-file"></i><?php echo $this->crud_model->get_lessons('course', $course_details['id'])->num_rows().' '.translate('lessons'); ?></li>

          <li><i class="far fa-compass"></i><?php echo translate('full_lifetime_access'); ?></li>

          <li><i class="fas fa-mobile-alt"></i><?php echo translate('access_on_mobile_and_tv'); ?></li>
    ...
    <div class="modal-dialog modal-lg" role="document">
      ...
      <div class="modal-content course-preview-modal">
        ...
        <div class="modal-header">
          ...
          <h5 class="modal-title"><span><?php echo translate('course_preview') ?>:</span><?php echo $course_details['title']; ?></h5>
          ...
          <div class="course-preview-video-wrap">
            ...
            <div class="embed-responsive embed-responsive-16by9">
              ...
              <?php if (strtolower(strtolower($provider)) == 'youtube'): ?>
                ...
                <link rel="stylesheet" href="<?php echo base_url();?>vendors/assets/global/plyr/plyr.css">
                ...
                <script src="<?php echo base_url();?>vendors/assets/global/plyr/plyr.js"></script>
                  ...
                  <?php if (get_video_extension($course_details['video_url']) == 'mp4'): ?>
                    ...
                    <?php elseif (get_video_extension($course_details['video_url']) == 'webm'): ?>
                      ...
                      <?php else: ?>
                        ...
                        <h4><?php translate('video_url_is_not_supported'); ?></h4>
      ...
      $.ajax({
...

        {
          ...
          if ($(elem).hasClass('addedToCart')) {
            ...
            $(elem).text("<?php echo translate('add_to_cart'); ?>");

          }else {

            $(elem).addClass('addedToCart')

            $(elem).text("<?php echo translate('added_to_cart'); ?>");
...

        {
          ...
          $.ajax({
...

            {
              ...
              toastr.warning('<?php echo translate('please_wait').'....'; ?>');
      ...
      $.ajax({
...

        {
          ...
          if (!response) {
            ...
            window.location.replace("<?php echo site_url('auth'); ?>");
...

            {
                ...
                if (!response) {
                    ...
                    if ($(elem).hasClass('active')) {
                        ...
                        $(elem).text("<?php echo translate('add_to_wishlist'); ?>");

                    }else {

                        $(elem).addClass('active');

                        $(elem).text("<?php echo translate('added_to_wishlist'); ?>");
